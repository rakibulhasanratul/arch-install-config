...
pacstrap -K /mnt base base-devel linux-lts linux-lts-headers linux-firmware btrfs-progs networkmanager sudo nano vim git fish nvim grub wget curl gvfs gvfs-mtp mtpfs libmtp tree-sitter-cli efibootmgr
